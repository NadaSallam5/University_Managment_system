...
namespace Project3 {
	...
	/// Summary for year1_R
	/// </summary>
	public ref class year1_P: public System::Windows::Forms::Form
	{
	public:
		year1_P(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &year1_P::label1_Click);
			// 
			// richTextBox1
			// 
			...
			this->richTextBox1->TextChanged += gcnew System::EventHandler(this, &year1_P::richTextBox1_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &year1_P::button1_Click);
			// 
			// year1_R
			// 
			...
			this->Name = L"year1_R";
			this->Text = L"year1_P";
			this->Load += gcnew System::EventHandler(this, &year1_P::year1_R_Load);
